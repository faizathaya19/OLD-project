...
<!-- hero start -->
<div class="container">
    <div class="top-area shadow p-3 mb-5 rounded daftar">
  <div class="row align-items-center justify-content-center p-5">
    <div class="col-lg-6 col-md-12 col-12">
    <img src="assets/images/c9749164-a510-468e-ac54-02b36ec4d2ee.jpg" style="height: 30em; " alt="">
    </div>
    <div class="col-lg-6 col-md-12 col-12">
    <form action="assets/function/daftar.php" method="POST" enctype="multipart/form-data">
        <input type="text" class="form-control my-2" name="nama" placeholder="nama lengkap" pattern="[A-Z a-z]{3,}" title="Tidak boleh ada angka" required>
        ...
        <button type="submit" value="submit" name="submit" class="btn btn-success">daftar</button>
