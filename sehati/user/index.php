...
<div class="container-fluid align-items-center text-center" id="ktgr">
...
<div class="container-fluid px-3 ">
  <div class="row " >
  <?php 
$pdk = mysqli_query($conn, "SELECT * FROM tb_data_produk LEFT JOIN tb_kategori USING (ktgr_id)  ORDER BY pdk_data_id DESC");
if(mysqli_num_rows($pdk) > 0){
while($row = mysqli_fetch_assoc($pdk)){
?>
